...
import com.asukacorp.aismobile.Data.Project.DetailJobOrder.JoCpr;
import com.asukacorp.aismobile.Data.Project.DetailJobOrder.JoCprRest;
...
public class JobOrderDetailCprActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuJoDoc.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(JobOrderDetailCprActivity.this, JobOrderDetailPictureActivity.class);
                intent.putExtra("detailJO", jobOrder);
                startActivityForResult(intent,1);
                finish();
            }
