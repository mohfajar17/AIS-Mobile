...
public class FollowupsCustomerDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_followups_customer_detail);
        ...
        textCustomer.setText(followup.getCompany_name());
        ...
        textNumber.setText("Followup Customer #" + followup.getLead_followup_id());
