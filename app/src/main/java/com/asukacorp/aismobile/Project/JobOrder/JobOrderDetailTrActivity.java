...
import com.asukacorp.aismobile.Data.Project.DetailJobOrder.JoTr;
...
public class JobOrderDetailTrActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuJoDoc.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(JobOrderDetailTrActivity.this, JobOrderDetailPictureActivity.class);
                intent.putExtra("detailJO", jobOrder);
                startActivityForResult(intent,1);
                finish();
            }
