...
public class TunjanganTemporary implements Parcelable {
    ...
    public TunjanganTemporary(int employee_allowance_id, String employee_allowance_number, String employee_id,
                              ...
                              String approval_comment2, String verified_by, String verified_date, String checked_by,
                              String checked_date, String checked_comment, String paid, String created_by, String created_date,
    ...
    protected TunjanganTemporary(Parcel in) {
        ...
        employee_grade_id = in.readString();
    ...
    public TunjanganTemporary(JSONObject jsonObject){
        try {
            ...
            this.employee_grade_id = jsonObject.getString("employee_grade_id");
    ...
    public static final Creator<TunjanganTemporary> CREATOR = new Creator<TunjanganTemporary>() {
        @Override
        public TunjanganTemporary createFromParcel(Parcel in) {
            return new TunjanganTemporary(in);
        }

        @Override
        public TunjanganTemporary[] newArray(int size) {
            return new TunjanganTemporary[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(employee_grade_id);
    ...
    public String getEmployee_grade_id() {
