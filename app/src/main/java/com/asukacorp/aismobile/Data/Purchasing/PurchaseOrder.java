...
public class PurchaseOrder implements Parcelable {
    ...
    private String contract_agreement_number;
    ...
    public PurchaseOrder(int purchase_order_id, String purchase_order_number, String purchase_order_type_id, String tax_type_id, String purchase_order_status_id,
                         String contract_agreement_id, String contract_agreement_number, String supplier_id, String purchase_quotation_number,
        ...
        this.contract_agreement_number = contract_agreement_number;
    ...
    protected PurchaseOrder(Parcel in) {
        ...
        contract_agreement_number = in.readString();
    ...
    public PurchaseOrder(JSONObject jsonObject){
        try {
            ...
            this.contract_agreement_number = jsonObject.getString("contract_agreement_number");
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(contract_agreement_number);
    ...
    public String getContract_agreement_number() {
        return contract_agreement_number;
    }
