...
import com.asukacorp.aismobile.Data.Project.DetailJobOrder.JoWo;
...
public class JobOrderDetailWoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuJoDoc.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(JobOrderDetailWoActivity.this, JobOrderDetailPictureActivity.class);
                intent.putExtra("detailJO", jobOrder);
                startActivityForResult(intent,1);
                finish();
            }
